...
require_once ($_SERVER["DOCUMENT_ROOT"] . "/mypage/include/header.php");
require_once ($_SERVER["DOCUMENT_ROOT"] . "/mypage/include/nav.php");

tp_read($_SERVER["DOCUMENT_ROOT"] . "/mypage/main.html");
...
require_once ($_SERVER["DOCUMENT_ROOT"] . "/mypage/include/footer.php");
