...
tp_read($_SERVER["DOCUMENT_ROOT"] . "/admin/include/nav.html");
...
tp_set("session_au_name", $_SESSION["session_au_name"]);
tp_set("admin_logout_url", $PATH_VAR["admin_logout_url"]);
tp_set("admin_info_url", $PATH_VAR["admin_info_url"]);
tp_set("admin_password_url", $PATH_VAR["admin_password_url"]);
