...
// 사용상태
$radio_array = array_flip($db_u_usestate_array);
$radio = get_input_radio("u_usestate", $radio_array, $row["u_usestate"], $color_u_usestate_array);
tp_set("radio_u_usestate", $radio);
